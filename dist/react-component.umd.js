...
function Customer(_ref) {
  ...
  return react["createElement"]("div", {
    ...
    src: __webpack_require__(11)("./".concat(customer.gender === 'FEM' ? 'female' : 'male', ".jpg")),
    alt: "John"
...
function (_React$Component) {
  ...
  function Profile(props) {
    ...
    _this = profile_possibleConstructorReturn(this, profile_getPrototypeOf(Profile).call(this, props));
    _this.state = {
      customer: props.customer
    };
    _this.updateCustomer = _this.updateCustomer.bind(profile_assertThisInitialized(profile_assertThisInitialized(_this)));
    _this.updateAddress = _this.updateAddress.bind(profile_assertThisInitialized(profile_assertThisInitialized(_this)));
    _this.updatePhoneNumber = _this.updatePhoneNumber.bind(profile_assertThisInitialized(profile_assertThisInitialized(_this)));
    _this.updateEmailAddress = _this.updateEmailAddress.bind(profile_assertThisInitialized(profile_assertThisInitialized(_this)));
...
// EXTERNAL MODULE: ./components/user.json
...
/* concated harmony reexport Profile */__webpack_require__.d(__webpack_exports__, "Profile", function() { return profile_Profile; });
